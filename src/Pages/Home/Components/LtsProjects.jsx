...
export default function LtsProjects() {
  ...
  return (
    <div className='mt-20 text-center'>
        ...
        <b className="text-5xl font-semibold text-sky-400"> <span className="text-orange-400">LTS</span> -Projects</b>

<div className="grid lg:grid-cols-4 mt-20 gap-2 sm:grid-cols-1 md:grid-cols-2">
