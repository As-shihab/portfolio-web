...
export default function page() {
  ...
  const [isideshbord , setDeshbord] =useState(false)
...
<div className={`flex flex-col py-2 bg-slate-800 ${iswebsites? `active-menu` : `not-menu`} rounded-lg px-4 cursor-pointer`} >
  <b className='text-xl flex items-center gap-1 select-none' onClick={()=>{setWebsites(!iswebsites)}} >  <CgWebsite/> Websites <MdKeyboardArrowDown className='text-slate-300 text-xl '  /> </b>
 <div className="ml-2 mt-2 menus">
 <NavLink to={`website/`+ 12}>
<li className='list-none flex justify-center items-center '>Crude</li>
</NavLink>
<NavLink to={`website/`+13}>
