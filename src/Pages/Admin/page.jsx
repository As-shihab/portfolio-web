...
<div className={`flex flex-col py-2 bg-slate-800 ${isposts? `active-menu` : `not-menu`} rounded-lg px-4 cursor-pointer`} >
  <b className='text-xl flex items-center gap-1 select-none' onClick={()=>{setPosts(!isposts)}} >  <CgWebsite/> Websites <MdKeyboardArrowDown className='text-slate-300 text-xl '  /> </b>
 <div className="ml-2 mt-2 menus">
