...
:      <div className='absolute top-[40%] left-2/4 flex flex-col -translate-x-2/4 w-5/6 m-auto text-center font-bold -translate-y-2/4 '>
<h1 className='lg:text-7xl animate-pulse text-gray-50'>Thanks for Creating account </h1><br />
